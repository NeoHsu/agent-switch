...
struct SyncArgs {
    ...
    /// Maximum number of Markdown source jobs to process.
    #[arg(long, value_name = "N")]
    max_files: Option<usize>,
    /// Maximum total bytes of canonical Markdown sources to read.
    #[arg(long, value_name = "BYTES")]
    max_source_bytes: Option<u64>,
    /// Maximum generated bytes for any one native output.
    #[arg(long, value_name = "BYTES")]
    max_output_bytes: Option<u64>,
    /// Maximum number of sync events to retain and emit.
    #[arg(long, value_name = "N")]
